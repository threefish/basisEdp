...
public class Department implements Serializable, Comparator<Department> {
    ...
    public void setDeptIcon(String orgIcon) {
        this.deptIcon = orgIcon;
    ...
    @Override
    public int compare(Department o0, Department o1) {
