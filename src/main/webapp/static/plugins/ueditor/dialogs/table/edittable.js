...
(function () {
    var title = $G("J_title"),
        ...
        tone = $G("J_tone"),
        fontFamily = $G("J_font_family"),
        borderSize = $G("J_borderSize"),
        me,
        preview = $G("J_preview");
    ...
    editTable.prototype = {
        init:function () {
            ...
            var table = domUtils.findParentByTagName(editor.selection.getRange().startContainer, 'table');;
            var _fontFamily=domUtils.getComputedStyle(table,'font-family');
            var _borderSize=table.getAttribute("border");
            fontFamily.value=_fontFamily;
            borderSize.value=(_borderSize==""||_borderSize==null||_borderSize==undefined)?"1":_borderSize;
    ...
    dialog.onok = function () {
        ...
        editor.execCommand("edittable", tone.value,fontFamily.value,borderSize.value);
